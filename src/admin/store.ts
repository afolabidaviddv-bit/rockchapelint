  ...
  return {
    ...
    settings: [
      row({
        ...
        email: site.email,
        phone: site.phone,
        phone_alt: site.phoneAlt,
        whatsapp: site.whatsapp,
        address: site.address,
        sunday_service: "9:00 AM",
        wednesday_service: "4:00 PM",
        bank_name: site.giving.bank,
        bank_account_name: site.giving.accountName,
        bank_account_number: site.giving.accountNumber,
        youtube_url: "",
        tiktok_url: "",
        instagram_url: "",
        x_url: "",
